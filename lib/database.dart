...
String databaseId = "6571acb638ae5fd76e6f";
...
Future<void> saveUserData(String name, String email, String userId) async {
  return await databases
      .createDocument(
          ...
          collectionId: "6571acf13bb0fb3ab497",
...
Future<void> createEvent(
  ...
  return await databases
      .createDocument(
          databaseId: databaseId,
          collectionId: "6571af5d0040308813f1",
          documentId: ID.unique(),
          data: {
            "name": name,
            "description": desc,
...
Future getAllEvents() async {
  try {
    final data = await databases.listDocuments(
        databaseId: databaseId, collectionId: "6571af5d0040308813f1");
